...
import pandas as pd
from artxgnn.collectors import DrugBundleAggregator
from artxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from artxgnn.collectors.drug_bundle import PredictedIndication
    from artxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from artxgnn.collectors.drug_bundle import DrugBundle
