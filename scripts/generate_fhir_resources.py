...
BASE_URL = "https://artxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "artxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "ARTxGNNFHIRServer",
        "title": "ARTxGNN FHIR Server - Argentina Drug Repurposing",
        "description": "FHIR R4 server for Argentina TxGNN drug repurposing predictions",
        "status": "active",
